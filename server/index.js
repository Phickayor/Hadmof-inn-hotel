...
var room_controller_1 = require("./src/controllers/room.controller");
var auth_model_1 = __importDefault(require("./src/models/auth.model"));
require("dotenv").config();
var app = (0, express_1.default)();
app.use((0, cors_1.default)());
app.use(body_parser_1.default.json());
(0, db_config_1.connectToDb)();
app.post("/auth/getcontactdetails/", function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var findUser, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, auth_model_1.default.findById(req.body.userId)];
            case 1:
                findUser = _a.sent();
                findUser
                    ? res.status(200).json({
...
app.post("/rooms/getroom/", room_controller_1.GetARoomById);
