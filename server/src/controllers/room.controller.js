...
var GetRooms = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                return [4 /*yield*/, rooms_model_1.default.find()];
            case 1:
                roomDetails = _a.sent();
                roomDetails
...
var AddRoom = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 5, , 6]);
                _a = req.body, roomName = _a.roomName, price = _a.price, description = _a.description, features = _a.features, image = _a.image;
                return [4 /*yield*/, rooms_model_1.default.findOne({ roomName: roomName })];
            case 1:
                checkRoom = _b.sent();
                console.log(checkRoom);
                if (!!checkRoom) return [3 /*break*/, 3];
                return [4 /*yield*/, rooms_model_1.default.create({
                        roomName: roomName,
                        price: price,
